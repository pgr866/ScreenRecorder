...
If you just want to use the recorder without building it yourself, download the precompiled executable from the **[Releases](https://github.com/pgr866/ScreenRecorder/releases)** section.
